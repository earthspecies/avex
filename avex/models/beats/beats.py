...
class BEATsConfig(BaseModel):
    ...
    # Spectrogram / preprocessing (consumed by the batched fbank frontend)
...
class BEATs(nn.Module):
    ...
    def preprocess(
        ...
        """
        # Batched GPU-native fbank (reproduces ta_kaldi.fbank) so the frontend
        # follows the model's device and runs on the whole batch at once.
