...
Deprecated:
    Use ``avex.models.utils.factory.build_model_from_spec``
...
from avex.models.clip import CLIPModel
from avex.models.efficientnet import (
    Model as EfficientNet,
)
from avex.models.perch import Model as PerchModel
from avex.models.resnet import Model as ResNetModel
...
def get_model(model_config: ModelSpec, num_classes: int) -> ModelBase:
    ...
    logger.warning(
        ...
        "Use avex.models.utils.factory.build_model_from_spec() instead."
    )
    ...
    if model_name == "efficientnet":
        ...
        return CLIPModel(
            ...
            efficientnet_variant=getattr(model_config, "efficientnet_variant", "b0"),
            audio_encoder_init_from=getattr(model_config, "audio_encoder_init_from", None),
        )
        ...
        from avex.models.beats_model import (
            Model as BeatsModel,
        )
        ...
        from avex.models.eat_hf import (
        ...
        from avex.models.birdnet import (
        ...
        from avex.models.birdmae import (
