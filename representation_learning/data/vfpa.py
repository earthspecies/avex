...
class VFPAKillerWhales(Dataset):
    ...
    info = DatasetInfo(
        ...
        owner="dclde_2026",
        split_paths={
            "all": "../../david_earthspecies_org/esp-data/vfpa/annotations_processed/all.csv",
            "srkw": "../esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/srkw.csv",
            "transient": "../esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/transient.csv",
            "boundary_pass": "../esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/boundary_pass.csv",
            "roberts_bank": "../esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/roberts_bank.csv",
            "srkw_standard": "../../david_earthspecies_org/esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/srkw_standard.csv",
            "srkw_standard_balanced": "../../david_earthspecies_org/esp-data/dclde_2026_killer_whales/vfpa/annotations_processed/srkw_standard_balanced.csv",
        },
        version="1.0.0",
        description=(
    ...
    def __init__(
        ...
        split : str
            ...
            - "srkw_standard_balanced": Balanced SRKW standard calls (max 50 per type, no singletons)
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        if idx >= len(self._data):
            raise IndexError(
                f"Index {idx} out of range (dataset length: {len(self._data)})"
            )
