...
class AVESConfig:
    def __init__(self, cfg=None):
        ...
        self.encoder_num_layers: int = 24  # number of encoder layers
        self.encoder_num_heads: int = 16  # number of attention heads
        self.encoder_attention_dropout: float = 0.1  # dropout for attention
        self.encoder_ff_interm_features: int = 4096  # intermediate features in FFN
