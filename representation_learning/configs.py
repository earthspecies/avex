...
class BenchmarkDatasetConfig(BaseModel):
    ...
    train_path: str = Field(..., description="Path to training annotations")
    valid_path: str = Field(..., description="Path to validation annotations")
    test_path: str = Field(..., description="Path to test annotations")
...
class BenchmarkConfig(BaseModel):
    ...
    datasets: List[BenchmarkDatasetConfig] = Field(..., description="List of benchmark datasets to evaluate")
...
def load_config(path: str | Path, config_type: Literal["run", "data", "evaluate", "benchmark"] = "run") -> Union[RunConfig, DataConfig, EvaluateConfig, BenchmarkDatasetConfig]:
    """Read YAML at *path*, validate, and return a config instance."""
