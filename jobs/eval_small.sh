...
# srun uv run repr-learn evaluate --config configs/evaluation_configs/icassp/bird_aves_bio.yml  --patch dataset_config=configs/data_configs/beans.yml
srun uv run repr-learn evaluate --config configs/evaluation_configs/icassp/beats.yml  --patch dataset_config=configs/data_configs/beans.yml
