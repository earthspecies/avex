...
<div class="resource-links">
  <a href="https://arxiv.org/abs/2508.11845" target="_blank" class="resource-link">
    <img src="_static/icons/paper.svg" class="resource-link-icon paper-icon" /> Paper
  </a>
  <span class="resource-link-sep">·</span>
  <a href="https://github.com/earthspecies/avex" target="_blank" rel="noopener" class="resource-link">
    <img src="_static/icons/github.svg" class="resource-link-icon github-icon" /> Code
  </a>
  <span class="resource-link-sep">·</span>
  <a href="https://huggingface.co/collections/EarthSpeciesProject/esp-aves2" target="_blank" class="resource-link">
    <img src="_static/icons/hf-logo.svg" class="resource-link-icon" /> Models
  </a>
</div>
```
