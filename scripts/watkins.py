...
local['unzip']['benchmark/watkins.zip', '-d', 'benchmark/watkins/'] & FG

df = pd.read_csv('benchmark/watkins/annotations.csv')
df = df.apply(lambda r: pd.Series({'path': f"benchmark/watkins/{r['path']}", 'label': r['species']}), axis=1)
...
df_train.to_csv('benchmark/watkins/annotations.train.csv')
df_train_low.to_csv('benchmark/watkins/annotations.train-low.csv')
df_valid.to_csv('benchmark/watkins/annotations.valid.csv')
df_test.to_csv('benchmark/watkins/annotations.test.csv')
