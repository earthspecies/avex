"""Utility module for loading Excel data files.

This module provides functions to load and read Excel files used in
the representation learning analysis scripts.
"""
