"""Tests for WeightedTransformerProbe."""
...
class TestWeightedTransformerProbe:
    """Test cases for WeightedTransformerProbe."""

    def test_feature_mode_with_input_dim(self) -> None:
        """Test WeightedTransformerProbe in feature mode with provided input_dim."""
        input_dim = 512
        num_classes = 10
        batch_size = 4
        seq_len = 50
        ...
        probe = WeightedTransformerProbe(
            base_model=None,
            layers=[],
    ...
    def test_feature_mode_with_base_model(self) -> None:
        """Test WeightedTransformerProbe in feature mode with base_model."""
        embedding_dims = [256]
        num_classes = 5
        batch_size = 2
        seq_len = 50
    ...
    def test_single_tensor_case(self) -> None:
        """Test WeightedTransformerProbe with single tensor embeddings."""
        embedding_dims = [256]
        num_classes = 8
        batch_size = 3
        num_heads = 4
    ...
    def test_list_embeddings_same_dimensions(self) -> None:
        """Test WeightedTransformerProbe with list of embeddings having
        same dimensions."""
        ...
        assert debug_info["probe_type"] == "weighted_transformer"
    ...
    def test_list_embeddings_different_dimensions_raises_error(self) -> None:
        """Test that WeightedTransformerProbe raises error for different
    ...
    def test_feature_mode_without_input_dim_raises_error(self) -> None:
        """Test that WeightedTransformerProbe raises error in feature mode
        without input_dim."""
        with pytest.raises(
    ...
    def test_positional_encoding(self) -> None:
        """Test WeightedTransformerProbe with positional encoding."""
        input_dim = 128
        num_classes = 4
        batch_size = 2
        seq_len = 30
    ...
    def test_no_positional_encoding(self) -> None:
        """Test WeightedTransformerProbe without positional encoding."""
        input_dim = 64
        num_classes = 3
        batch_size = 2
        seq_len = 20
    ...
    def test_dropout_rate(self) -> None:
        """Test WeightedTransformerProbe with different dropout rates."""
        input_dim = 64
        num_classes = 3
        batch_size = 2
        seq_len = 20
    ...
    def test_no_dropout(self) -> None:
        """Test WeightedTransformerProbe without dropout."""
        input_dim = 64
        num_classes = 3
        batch_size = 2
        seq_len = 20
    ...
    def test_multiple_transformer_layers(self) -> None:
        """Test WeightedTransformerProbe with multiple transformer layers."""
        input_dim = 96
        num_classes = 4
        batch_size = 2
        seq_len = 25
        ...
        assert probe.transformer.num_layers == num_layers
    ...
    def test_freeze_backbone(self) -> None:
        """Test WeightedTransformerProbe with frozen backbone."""
        embedding_dims = [256]
        num_classes = 3
        batch_size = 2
        num_heads = 4
    ...
    def test_dict_input(self) -> None:
        """Test WeightedTransformerProbe with dictionary input."""
        input_dim = 64
        num_classes = 2
        batch_size = 2
        seq_len = 30
    ...
    def test_3d_embedding_requirement(self) -> None:
        """Test that WeightedTransformerProbe requires 3D embeddings."""
        ...
        with pytest.raises(ValueError, match="Transformer probe expects 3D embeddings"):
            WeightedTransformerProbe(
                base_model=base_model,
                layers=["layer1"],
                num_classes=5,
    ...
    def test_target_length_parameter(self) -> None:
        """Test WeightedTransformerProbe with target_length parameter."""
        input_dim = 96
        num_classes = 3
        batch_size = 2
        target_length = 2000
    ...
    def test_transformer_configuration(self) -> None:
        """Test that transformer is configured correctly."""
        input_dim = 64
        num_classes = 2
        batch_size = 2
        seq_len = 20
        ...
        # Check first layer configuration
        first_layer = probe.transformer.layers[0]
        assert first_layer.self_attn.embed_dim == input_dim
        assert first_layer.self_attn.num_heads == num_heads
        assert first_layer.self_attn.dropout == dropout_rate
        assert first_layer.linear1.out_features == attention_dim
        assert first_layer.linear2.in_features == attention_dim
        assert first_layer.linear2.out_features == input_dim
