...
from representation_learning.models.probes.mlp_probe import (
    MLPProbe,
)
...
def test_mlp_feature_mode_with_input_dim() -> None:
    input_dim = 128
    num_classes = 4
    probe = MLPProbe(
        base_model=None,
...
def test_mlp_with_base_model_single() -> None:
...
def test_mlp_multi_layer_weighted_sum() -> None:
    base = MockBaseModel([32, 64, 32])
    probe = MLPProbe(
        base_model=base,
        layers=["l1", "l2", "l3"],
        num_classes=2,
